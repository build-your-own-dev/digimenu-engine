...
function Landing() {
  return <main className="landing">
    ...
    <section className="cta shell"><div><span className="section-kicker">BEREIT ZU SERVIEREN?</span><h2>Dein Menü gehört<br/>ins Jetzt.</h2><p>Kein Abo. Keine Kreditkarte. Keine Ausreden.</p></div><a className="button button-dark button-large" href="#/login">Restaurant kostenlos erstellen <ArrowRight size={18}/></a></section>
